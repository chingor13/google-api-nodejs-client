...
export namespace adexchangeseller_v1_1 {
  ...
  export class Resource$Preferreddeals {
     ...
     * @return {object} Request object
     */
    get(params?: Params$Resource$Preferreddeals$Get,
    ...
    get(paramsOrCallback?: Params$Resource$Preferreddeals$Get|
      ...
      let params =
          (paramsOrCallback || {}) as Params$Resource$Preferreddeals$Get;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Preferreddeals$Get;
        options = {};
      }
     ...
     * @return {object} Request object
     */
    list(params?: Params$Resource$Preferreddeals$List, options?: MethodOptions):
        AxiosPromise<Schema$PreferredDeals>;
    list(
        params: Params$Resource$Preferreddeals$List,
    ...
    list(
        paramsOrCallback?: Params$Resource$Preferreddeals$List|
      ...
      let params =
          (paramsOrCallback || {}) as Params$Resource$Preferreddeals$List;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Preferreddeals$List;
        options = {};
      }
  ...
  export interface Params$Resource$Preferreddeals$Get {
    /**
     * Auth client or API Key for the request
     */
    auth?: string|OAuth2Client|JWT|Compute|UserRefreshClient;
