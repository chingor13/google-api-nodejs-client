...
export namespace adexchangeseller_v2_0 {
  ...
  export class Resource$Accounts$Metadata$Dimensions {
     ...
     */
    list(
        params?: Params$Resource$Accounts$Metadata$Dimensions$List,
    ...
    list(
        paramsOrCallback?: Params$Resource$Accounts$Metadata$Dimensions$List|
      ...
      let params = (paramsOrCallback || {}) as
          Params$Resource$Accounts$Metadata$Dimensions$List;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Accounts$Metadata$Dimensions$List;
        options = {};
      }
  ...
  export interface Params$Resource$Accounts$Metadata$Dimensions$List {
    /**
     * Auth client or API Key for the request
     */
    auth?: string|OAuth2Client|JWT|Compute|UserRefreshClient;
  ...
  export class Resource$Accounts$Metadata$Metrics {
     ...
     */
    list(
        params?: Params$Resource$Accounts$Metadata$Metrics$List,
        options?: MethodOptions): AxiosPromise<Schema$Metadata>;
    list(
        params: Params$Resource$Accounts$Metadata$Metrics$List,
        options: MethodOptions|BodyResponseCallback<Schema$Metadata>,
    ...
    list(callback: BodyResponseCallback<Schema$Metadata>): void;
    list(
        paramsOrCallback?: Params$Resource$Accounts$Metadata$Metrics$List|
        BodyResponseCallback<Schema$Metadata>,
        optionsOrCallback?: MethodOptions|BodyResponseCallback<Schema$Metadata>,
        callback?: BodyResponseCallback<Schema$Metadata>):
        void|AxiosPromise<Schema$Metadata> {
      let params = (paramsOrCallback || {}) as
          Params$Resource$Accounts$Metadata$Metrics$List;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Accounts$Metadata$Metrics$List;
        options = {};
      }
  ...
  export interface Params$Resource$Accounts$Metadata$Metrics$List {
    /**
     * Auth client or API Key for the request
     */
    auth?: string|OAuth2Client|JWT|Compute|UserRefreshClient;
  ...
  export class Resource$Accounts$Preferreddeals {
     ...
     * @return {object} Request object
     */
    get(params?: Params$Resource$Accounts$Preferreddeals$Get,
    ...
    get(paramsOrCallback?: Params$Resource$Accounts$Preferreddeals$Get|
        BodyResponseCallback<Schema$PreferredDeal>,
        optionsOrCallback?: MethodOptions|
        BodyResponseCallback<Schema$PreferredDeal>,
        callback?: BodyResponseCallback<Schema$PreferredDeal>):
        void|AxiosPromise<Schema$PreferredDeal> {
      let params = (paramsOrCallback || {}) as
          Params$Resource$Accounts$Preferreddeals$Get;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Accounts$Preferreddeals$Get;
        options = {};
      }
     ...
     */
    list(
        params?: Params$Resource$Accounts$Preferreddeals$List,
        options?: MethodOptions): AxiosPromise<Schema$PreferredDeals>;
    list(
        params: Params$Resource$Accounts$Preferreddeals$List,
    ...
    list(
        paramsOrCallback?: Params$Resource$Accounts$Preferreddeals$List|
        BodyResponseCallback<Schema$PreferredDeals>,
        optionsOrCallback?: MethodOptions|
        BodyResponseCallback<Schema$PreferredDeals>,
        callback?: BodyResponseCallback<Schema$PreferredDeals>):
        void|AxiosPromise<Schema$PreferredDeals> {
      let params = (paramsOrCallback || {}) as
          Params$Resource$Accounts$Preferreddeals$List;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Accounts$Preferreddeals$List;
        options = {};
      }
  ...
  export interface Params$Resource$Accounts$Preferreddeals$Get {
    /**
     * Auth client or API Key for the request
     */
    auth?: string|OAuth2Client|JWT|Compute|UserRefreshClient;
