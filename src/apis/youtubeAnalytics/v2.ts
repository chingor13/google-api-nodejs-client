...
export namespace youtubeAnalytics_v2 {
  ...
  export class Resource$Groupitems {
     ...
     *     item ID of the group item that is being deleted.
     * @param {string=} params.onBehalfOfContentOwner This parameter can only be
     *     used in a properly authorized request. **Note:** This parameter is
     *     intended exclusively for YouTube content partners that own and manage
     *     many different YouTube channels.  The `onBehalfOfContentOwner`
     *     parameter indicates that the request's authorization credentials
     *     identify a YouTube user who is acting on behalf of the content owner
     *     specified in the parameter value. It allows content owners to
     ...
     *
     * @param {object} params Parameters for request
     * @param {string=} params.groupId The `groupId` parameter specifies the
     *     unique ID of the group for which you want to retrieve group items.
     * @param {string=} params.onBehalfOfContentOwner This parameter can only be
     *     used in a properly authorized request. **Note:** This parameter is
     *     intended exclusively for YouTube content partners that own and manage
     *     many different YouTube channels.  The `onBehalfOfContentOwner`
  ...
  export class Resource$Groups {
     ...
     *     retrieved. Each group must be owned by the authenticated user. In a
     *     `group` resource, the `id` property specifies the group's YouTube
     *     group ID.  Note that if you do not specify a value for the `id`
     *     parameter, then you must set the `mine` parameter to `true`.
     * @param {boolean=} params.mine This parameter can only be used in a
  ...
  export class Resource$Reports {
     ...
     *     with an error if the specified currency is not recognized.", pattern:
     *     [A-Z]{3}
     ...
     *     for a list of the reports that you can retrieve and the dimensions
     *     used for those reports. Also see the
     *     [Dimensions](/youtube/analytics/v2/dimsmets/dims) document for
     *     definitions of those dimensions." pattern: [0-9a-zA-Z,]+
     * @param {string=} params.endDate The end date for fetching YouTube
     *     Analytics data. The value should be in `YYYY-MM-DD` format. required:
     *     true, pattern: [0-9]{4}-[0-9]{2}-[0-9]{2}
     * @param {string=} params.filters A list of filters that should be applied
     *     when retrieving YouTube Analytics data. The [Available
     *     Reports](/youtube/analytics/v2/available_reports) document identifies
     *     the dimensions that can be used to filter each report, and the
     *     [Dimensions](/youtube/analytics/v2/dimsmets/dims)  document defines
     ...
     * @param {boolean=} params.includeHistoricalChannelData If set to true
     *     historical data (i.e. channel data from before the linking of the
     *     channel to the content owner) will be retrieved.",
     * @param {integer=} params.maxResults The maximum number of rows to include
     *     in the response.", minValue: 1
     * @param {string=} params.metrics A comma-separated list of YouTube
     *     Analytics metrics, such as `views` or `likes,dislikes`. See the
     *     [Available Reports](/youtube/analytics/v2/available_reports) document
     *     for a list of the reports that you can retrieve and the metrics
     ...
     *     default the sort order is ascending. The '`-`' prefix causes
     *     descending sort order.", pattern: [-0-9a-zA-Z,]+
     * @param {string=} params.startDate The start date for fetching YouTube
     *     Analytics data. The value should be in `YYYY-MM-DD` format. required:
     *     true, pattern: "[0-9]{4}-[0-9]{2}-[0-9]{2}
     * @param {integer=} params.startIndex An index of the first entity to
