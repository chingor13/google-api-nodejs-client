...
export namespace serviceuser_v1 {
  ...
  export interface Schema$HttpRule {
     ...
     * the response message will be used as HTTP body of response. NOTE: the
     * referred field must be not a repeated field and must be present at the
     * top-level of response message type.
     */
    responseBody?: string;
    /**
  ...
  export class Resource$Projects$Services {
    ...
    list(
      ...
      if (callback) {
        createAPIRequest<Schema$ListEnabledServicesResponse>(
            parameters, callback);
      } else {
        return createAPIRequest<Schema$ListEnabledServicesResponse>(parameters);
      }
    }
  }
  ...
  export class Resource$Services {
    ...
    search(
      ...
      if (callback) {
        createAPIRequest<Schema$SearchServicesResponse>(parameters, callback);
      } else {
