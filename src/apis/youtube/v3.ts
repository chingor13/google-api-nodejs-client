...
export namespace youtube_v3 {
  ...
  export class Resource$Activities {
     ...
     * @param {string} params.part The part parameter serves two purposes in
     *     this operation. It identifies the properties that the write operation
     ...
     *
     * @param {object} params Parameters for request
     * @param {string=} params.channelId The channelId parameter specifies a
     *     unique YouTube channel ID. The API will then return a list of that
     *     channel's activities.
     * @param {boolean=} params.home Set this parameter's value to true to
     *     retrieve the activity feed that displays on the YouTube home page for
     *     the currently authenticated user.
     * @param {integer=} params.maxResults The maxResults parameter specifies
     *     the maximum number of items that should be returned in the result
     *     set.
     * @param {boolean=} params.mine Set this parameter's value to true to
     *     retrieve a feed of the authenticated user's activities.
     * @param {string=} params.pageToken The pageToken parameter identifies a
     *     specific page in the result set that should be returned. In an API
     *     response, the nextPageToken and prevPageToken properties identify
     *     other pages that could be retrieved.
     * @param {string} params.part The part parameter specifies a
     *     comma-separated list of one or more activity resource properties that
     ...
     *     included in the response. For example, in an activity resource, the
     *     snippet property contains other properties that identify the type of
     *     activity, a display title for the activity, and so forth. If you set
     *     part=snippet, the API response will also contain all of those nested
     *     properties.
     * @param {string=} params.publishedAfter The publishedAfter parameter
     *     specifies the earliest date and time that an activity could have
     *     occurred for that activity to be included in the API response. If the
     *     parameter value specifies a day, but not a time, then any activities
     *     that occurred that day will be included in the result set. The value
     *     is specified in ISO 8601 (YYYY-MM-DDThh:mm:ss.sZ) format.
     * @param {string=} params.publishedBefore The publishedBefore parameter
     *     specifies the date and time before which an activity must have
     *     occurred for that activity to be included in the API response. If the
     *     parameter value specifies a day, but not a time, then any activities
     *     that occurred that day will be excluded from the result set. The
     *     value is specified in ISO 8601 (YYYY-MM-DDThh:mm:ss.sZ) format.
     * @param {string=} params.regionCode The regionCode parameter instructs the
     *     API to return results for the specified country. The parameter value
     *     is an ISO 3166-1 alpha-2 country code. YouTube uses this value when
     *     the authorized user's previous activity on YouTube does not provide
     *     enough information to generate the activity feed.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
  ...
  export class Resource$Captions {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.id The id parameter identifies the caption track
     *     that is being deleted. The value is a caption track ID as identified
     *     by the id property in a caption resource.
     * @param {string=} params.onBehalfOf ID of the Google+ Page for the channel
     *     that the request is be on behalf of
     * @param {string=} params.onBehalfOfContentOwner Note: This parameter is
     ...
     * @param {object} params Parameters for request
     * @param {string} params.id The id parameter identifies the caption track
     *     that is being retrieved. The value is a caption track ID as
     *     identified by the id property in a caption resource.
     * @param {string=} params.onBehalfOf ID of the Google+ Page for the channel
     *     that the request is be on behalf of
     * @param {string=} params.onBehalfOfContentOwner Note: This parameter is
     *     intended exclusively for YouTube content partners.  The
     ...
     *     authenticates with must be linked to the specified YouTube content
     *     owner.
     * @param {string=} params.tfmt The tfmt parameter specifies that the
     *     caption track should be returned in a specific format. If the
     *     parameter is not included in the request, the track is returned in
     *     its original format.
     * @param {string=} params.tlang The tlang parameter specifies that the API
     *     response should return a translation of the specified caption track.
     *     The parameter value is an ISO 639-1 two-letter language code that
     *     identifies the desired caption language. The translation is generated
     *     by using machine translation, such as Google Translate.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
     ...
     *     authenticates with must be linked to the specified YouTube content
     *     owner.
     * @param {string} params.part The part parameter specifies the caption
     *     resource parts that the API response will include. Set the parameter
     *     value to snippet.
     * @param {boolean=} params.sync The sync parameter indicates whether
     ...
     *     disregard any time codes that are in the uploaded caption file and
     *     generate new time codes for the captions.  You should set the sync
     *     parameter to true if you are uploading a transcript, which has no
     *     time codes, or if you suspect the time codes in your file are
     ...
     *
     * @param {object} params Parameters for request
     * @param {string=} params.id The id parameter specifies a comma-separated
     *     list of IDs that identify the caption resources that should be
     *     retrieved. Each ID must identify a caption track associated with the
     *     specified video.
     * @param {string=} params.onBehalfOf ID of the Google+ Page for the channel
     ...
     *     owner.
     * @param {string} params.part The part parameter specifies a
     *     comma-separated list of one or more caption resource parts that the
     *     API response will include. The part names that you can include in the
     *     parameter value are id and snippet.
     * @param {string} params.videoId The videoId parameter specifies the
     *     YouTube video ID of the video for which the API should return caption
     *     tracks.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     ...
     *     this operation. It identifies the properties that the write operation
     *     will set as well as the properties that the API response will
     *     include. Set the property value to snippet if you are updating the
     *     track's draft status. Otherwise, set the property value to id.
     * @param {boolean=} params.sync Note: The API server only processes the
     *     parameter value if the request contains an updated caption file.  The
     *     sync parameter indicates whether YouTube should automatically
  ...
  export class Resource$Channelbanners {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string=} params.channelId The channelId parameter identifies the
     *     YouTube channel to which the banner is uploaded. The channelId
     *     parameter was introduced as a required parameter in May 2017. As this
     *     was a backward-incompatible change, channelBanners.insert requests
     *     that do not specify this parameter will not return an error until six
     *     months have passed from the time that the parameter was introduced.
     *     Please see the API Terms of Service for the official policy regarding
     *     backward incompatible changes and the API revision history for the
  ...
  export class Resource$Channels {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string=} params.categoryId The categoryId parameter specifies a
     *     YouTube guide category, thereby requesting YouTube channels
     *     associated with that category.
     * @param {string=} params.forUsername The forUsername parameter specifies a
     *     YouTube username, thereby requesting the channel associated with that
     *     username.
     * @param {string=} params.hl The hl parameter should be used for filter out
     *     the properties that are not in the given language. Used for the
     *     brandingSettings part.
     * @param {string=} params.id The id parameter specifies a comma-separated
     *     list of the YouTube channel ID(s) for the resource(s) that are being
     *     retrieved. In a channel resource, the id property specifies the
     *     channel's YouTube channel ID.
     * @param {boolean=} params.managedByMe Note: This parameter is intended
     *     exclusively for YouTube content partners.  Set this parameter's value
     *     to true to instruct the API to only return channels managed by the
     *     content owner that the onBehalfOfContentOwner parameter specifies.
     *     The user must be authenticated as a CMS account linked to the
     *     specified content owner and onBehalfOfContentOwner must be provided.
     * @param {integer=} params.maxResults The maxResults parameter specifies
     *     the maximum number of items that should be returned in the result
     *     set.
     * @param {boolean=} params.mine Set this parameter's value to true to
     *     instruct the API to only return channels owned by the authenticated
     *     user.
     * @param {boolean=} params.mySubscribers Use the subscriptions.list method
     *     and its mySubscribers parameter to retrieve a list of subscribers to
     ...
     *     other pages that could be retrieved.
     * @param {string} params.part The part parameter specifies a
     *     comma-separated list of one or more channel resource properties that
     *     the API response will include.  If the parameter identifies a
     *     property that contains child properties, the child properties will be
     *     included in the response. For example, in a channel resource, the
     *     contentDetails property contains other properties, such as the
     ...
     *
     * @param {object} params Parameters for request
     * @param {string=} params.onBehalfOfContentOwner The onBehalfOfContentOwner
     *     parameter indicates that the authenticated user is acting on behalf
     *     of the content owner specified in the parameter value. This parameter
     *     is intended for YouTube content partners that own and manage many
  ...
  export class Resource$Channelsections {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.id The id parameter specifies the YouTube
     *     channelSection ID for the resource that is being deleted. In a
     ...
     *     individual channel. The CMS account that the user authenticates with
     *     must be linked to the specified YouTube content owner.
     * @param {string=} params.onBehalfOfContentOwnerChannel This parameter can
     *     only be used in a properly authorized request. Note: This parameter
     ...
     * @param {object} params Parameters for request
     * @param {string=} params.channelId The channelId parameter specifies a
     *     YouTube channel ID. The API will only return that channel's
     *     channelSections.
     * @param {string=} params.hl The hl parameter indicates that the
     *     snippet.localized property values in the returned channelSection
     ...
     * @param {string=} params.id The id parameter specifies a comma-separated
     *     list of the YouTube channelSection ID(s) for the resource(s) that are
     *     being retrieved. In a channelSection resource, the id property
     *     specifies the YouTube channelSection ID.
     * @param {boolean=} params.mine Set this parameter's value to true to
     *     retrieve a feed of the authenticated user's channelSections.
     * @param {string=} params.onBehalfOfContentOwner Note: This parameter is
     *     intended exclusively for YouTube content partners.  The
     *     onBehalfOfContentOwner parameter indicates that the request's
     *     authorization credentials identify a YouTube CMS user who is acting
     ...
     *     properties that the API response will include. The part names that
     *     you can include in the parameter value are id, snippet, and
     *     contentDetails.  If the parameter identifies a property that contains
  ...
  export class Resource$Comments {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.id The id parameter specifies the comment ID for
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.part The part parameter identifies the properties
     *     that the API response will include. Set the parameter value to
     *     snippet. The snippet part has a quota cost of 2 units.
     ...
     * @param {object} params Parameters for request
     * @param {string=} params.id The id parameter specifies a comma-separated
     *     list of comment IDs for the resources that are being retrieved. In a
     *     comment resource, the id property specifies the comment's ID.
     * @param {integer=} params.maxResults The maxResults parameter specifies
     *     the maximum number of items that should be returned in the result
     *     set.  Note: This parameter is not supported for use in conjunction
     *     with the id parameter.
     * @param {string=} params.pageToken The pageToken parameter identifies a
     *     specific page in the result set that should be returned. In an API
     *     response, the nextPageToken property identifies the next page of the
     *     result that can be retrieved.  Note: This parameter is not supported
     *     for use in conjunction with the id parameter.
     * @param {string=} params.parentId The parentId parameter specifies the ID
     *     of the comment for which replies should be retrieved.  Note: YouTube
     *     currently supports replies only for top-level comments. However,
     *     replies to replies may be supported in the future.
     * @param {string} params.part The part parameter specifies a
     *     comma-separated list of one or more comment resource properties that
     *     the API response will include.
     * @param {string=} params.textFormat This parameter indicates whether the
     *     API should return comments formatted as HTML or as plain text.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
     ...
     * @param {object} params Parameters for request
     * @param {string} params.id The id parameter specifies a comma-separated
     *     list of IDs of comments that the caller believes should be classified
     *     as spam.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     ...
     *
     * @param {object} params Parameters for request
     * @param {boolean=} params.banAuthor The banAuthor parameter lets you
     *     indicate that you want to automatically reject any additional
     *     comments written by the comment's author. Set the parameter value to
     *     true to ban the author.  Note: This parameter is only valid if the
     *     moderationStatus parameter is also set to rejected.
     * @param {string} params.id The id parameter specifies a comma-separated
     *     list of IDs that identify the comments for which you are updating the
     *     moderation status.
     * @param {string} params.moderationStatus Identifies the new moderation
     *     status of the specified comments.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
  ...
  export class Resource$Commentthreads {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string=} params.allThreadsRelatedToChannelId The
     *     allThreadsRelatedToChannelId parameter instructs the API to return
     *     all comment threads associated with the specified channel. The
     *     response can include comments about the channel or about the
     *     channel's videos.
     * @param {string=} params.channelId The channelId parameter instructs the
     *     API to return comment threads containing comments about the specified
     *     channel. (The response will not include comments left on videos that
     *     the channel uploaded.)
     * @param {string=} params.id The id parameter specifies a comma-separated
     *     list of comment thread IDs for the resources that should be
     *     retrieved.
     * @param {integer=} params.maxResults The maxResults parameter specifies
     *     the maximum number of items that should be returned in the result
     *     set.  Note: This parameter is not supported for use in conjunction
     *     with the id parameter.
     * @param {string=} params.moderationStatus Set this parameter to limit the
     *     returned comment threads to a particular moderation state.  Note:
     ...
     *     which the API response should list comment threads. Valid values are:
     *     - time - Comment threads are ordered by time. This is the default
     *     behavior. - relevance - Comment threads are ordered by
     ...
     *     for use in conjunction with the id parameter.
     * @param {string} params.part The part parameter specifies a
     *     comma-separated list of one or more commentThread resource properties
     *     that the API response will include.
     * @param {string=} params.searchTerms The searchTerms parameter instructs
     *     the API to limit the API response to only contain comments that
     *     contain the specified search terms.  Note: This parameter is not
     *     supported for use in conjunction with the id parameter.
     * @param {string=} params.textFormat Set this parameter's value to html or
     *     plainText to instruct the API to return the comments left by users in
     *     html formatted or in plain text.
     * @param {string=} params.videoId The videoId parameter instructs the API
     *     to return comment threads associated with the specified video ID.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
     ...
     * @param {object} params Parameters for request
     * @param {string} params.part The part parameter specifies a
     *     comma-separated list of commentThread resource properties that the
     *     API response will include. You must at least include the snippet part
     *     in the parameter value since that part contains all of the properties
  ...
  export class Resource$Guidecategories {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string=} params.hl The hl parameter specifies the language that
     *     will be used for text values in the API response.
     * @param {string=} params.id The id parameter specifies a comma-separated
     *     list of the YouTube channel category ID(s) for the resource(s) that
     *     are being retrieved. In a guideCategory resource, the id property
     *     specifies the YouTube channel category ID.
     * @param {string} params.part The part parameter specifies the
     *     guideCategory resource properties that the API response will include.
     *     Set the parameter value to snippet.
     * @param {string=} params.regionCode The regionCode parameter instructs the
     *     API to return the list of guide categories available in the specified
  ...
  export class Resource$I18nlanguages {
     ...
     * @param {object} params Parameters for request
     * @param {string=} params.hl The hl parameter specifies the language that
     *     should be used for text values in the API response.
     * @param {string} params.part The part parameter specifies the i18nLanguage
  ...
  export class Resource$I18nregions {
     ...
     * @param {string=} params.hl The hl parameter specifies the language that
     *     should be used for text values in the API response.
     * @param {string} params.part The part parameter specifies the i18nRegion
     *     resource properties that the API response will include. Set the
     *     parameter value to snippet.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
  ...
  export class Resource$Livebroadcasts {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.id The id parameter specifies the unique ID of the
     *     broadcast that is being bound to a video stream.
     * @param {string=} params.onBehalfOfContentOwner Note: This parameter is
     *     intended exclusively for YouTube content partners.  The
     *     onBehalfOfContentOwner parameter indicates that the request's
     *     authorization credentials identify a YouTube CMS user who is acting
     ...
     *     for each separate channel.
     * @param {string} params.part The part parameter specifies a
     *     comma-separated list of one or more liveBroadcast resource properties
     *     that the API response will include. The part names that you can
     *     include in the parameter value are id, snippet, contentDetails, and
     *     status.
     * @param {string=} params.streamId The streamId parameter specifies the
     *     unique ID of the video stream that is being bound to a broadcast. If
     *     this parameter is omitted, the API will remove any existing binding
     *     between the broadcast and a video stream.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
     ...
     *
     * @param {object} params Parameters for request
     * @param {boolean=} params.displaySlate The displaySlate parameter
     *     specifies whether the slate is being enabled or disabled.
     * @param {string} params.id The id parameter specifies the YouTube live
     *     broadcast ID that uniquely identifies the broadcast in which the
     *     slate is being updated.
     * @param {string=} params.offsetTimeMs The offsetTimeMs parameter specifies
     *     a positive time offset when the specified slate change will occur.
     *     The value is measured in milliseconds from the beginning of the
     *     broadcast's monitor stream, which is the time that the testing phase
     *     for the broadcast began. Even though it is specified in milliseconds,
     *     the value is actually an approximation, and YouTube completes the
     *     requested action as closely as possible to that time.  If you do not
     *     specify a value for this parameter, then YouTube performs the action
     *     as soon as possible. See the Getting started guide for more details.
     ...
     *     include in the parameter value are id, snippet, contentDetails, and
     *     status.
     * @param {string=} params.walltime The walltime parameter specifies the
     *     wall clock time at which the specified slate change will occur. The
     ...
     * @param {object} params Parameters for request
     * @param {string} params.id The id parameter specifies the YouTube live
     *     broadcast ID for the resource that is being deleted.
     * @param {string=} params.onBehalfOfContentOwner Note: This parameter is
     *     intended exclusively for YouTube content partners.  The
     *     onBehalfOfContentOwner parameter indicates that the request's
     *     authorization credentials identify a YouTube CMS user who is acting
     ...
     *
     * @param {object} params Parameters for request
     * @param {string=} params.broadcastStatus The broadcastStatus parameter
     *     filters the API response to only include broadcasts with the
     *     specified status.
     * @param {string=} params.broadcastType The broadcastType parameter filters
     *     the API response to only include broadcasts with the specified type.
     *     This is only compatible with the mine filter for now.
     * @param {string=} params.id The id parameter specifies a comma-separated
     *     list of YouTube broadcast IDs that identify the broadcasts being
     *     retrieved. In a liveBroadcast resource, the id property specifies the
     *     broadcast's ID.
     * @param {integer=} params.maxResults The maxResults parameter specifies
     *     the maximum number of items that should be returned in the result
     *     set.
     * @param {boolean=} params.mine The mine parameter can be used to instruct
     *     the API to only return broadcasts owned by the authenticated user.
     *     Set the parameter value to true to only retrieve your own broadcasts.
     * @param {string=} params.onBehalfOfContentOwner Note: This parameter is
     *     intended exclusively for YouTube content partners.  The
     *     onBehalfOfContentOwner parameter indicates that the request's
     *     authorization credentials identify a YouTube CMS user who is acting
     ...
     * @param {object} params Parameters for request
     * @param {string} params.broadcastStatus The broadcastStatus parameter
     *     identifies the state to which the broadcast is changing. Note that to
     *     transition a broadcast to either the testing or live state, the
     *     status.streamStatus must be active for the stream that the broadcast
     *     is bound to.
     * @param {string} params.id The id parameter specifies the unique ID of the
     *     broadcast that is transitioning to another status.
     * @param {string=} params.onBehalfOfContentOwner Note: This parameter is
     *     intended exclusively for YouTube content partners.  The
     *     onBehalfOfContentOwner parameter indicates that the request's
     *     authorization credentials identify a YouTube CMS user who is acting
     ...
     *     not specify a value, the existing privacy setting will be removed and
  ...
  export class Resource$Livechatbans {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.id The id parameter identifies the chat ban to
     *     remove. The value uniquely identifies both the ban and the chat.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
     ...
     * @param {string} params.part The part parameter serves two purposes in
     *     this operation. It identifies the properties that the write operation
     *     will set as well as the properties that the API response returns. Set
  ...
  export class Resource$Livechatmessages {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.id The id parameter specifies the YouTube chat
     *     message ID of the resource that is being deleted.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.part The part parameter serves two purposes. It
     ...
     *
     * @param {object} params Parameters for request
     * @param {string=} params.hl The hl parameter instructs the API to retrieve
     *     localized resource metadata for a specific application language that
     *     the YouTube website supports. The parameter value must be a language
     *     code included in the list returned by the i18nLanguages.list method.
     ...
     * @param {string} params.liveChatId The liveChatId parameter specifies the
     *     ID of the chat whose messages will be returned.
     * @param {integer=} params.maxResults The maxResults parameter specifies
     *     the maximum number of messages that should be returned in the result
     *     set.
     * @param {string=} params.pageToken The pageToken parameter identifies a
     *     specific page in the result set that should be returned. In an API
     *     response, the nextPageToken property identify other pages that could
     *     be retrieved.
     * @param {string} params.part The part parameter specifies the
     *     liveChatComment resource parts that the API response will include.
     *     Supported values are id and snippet.
     * @param {integer=} params.profileImageSize The profileImageSize parameter
     *     specifies the size of the user profile pictures that should be
  ...
  export class Resource$Livechatmoderators {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.id The id parameter identifies the chat moderator
     *     to remove. The value uniquely identifies both the moderator and the
     *     chat.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     ...
     * @param {object} params Parameters for request
     * @param {string} params.liveChatId The liveChatId parameter specifies the
     *     YouTube live chat for which the API should return moderators.
     * @param {integer=} params.maxResults The maxResults parameter specifies
     *     the maximum number of items that should be returned in the result
     *     set.
     * @param {string=} params.pageToken The pageToken parameter identifies a
  ...
  export class Resource$Livestreams {
     ...
     * @param {object} params Parameters for request
     * @param {string} params.id The id parameter specifies the YouTube live
     *     stream ID for the resource that is being deleted.
     * @param {string=} params.onBehalfOfContentOwner Note: This parameter is
     *     intended exclusively for YouTube content partners.  The
     *     onBehalfOfContentOwner parameter indicates that the request's
     *     authorization credentials identify a YouTube CMS user who is acting
     ...
     * @param {object} params Parameters for request
     * @param {string=} params.id The id parameter specifies a comma-separated
     *     list of YouTube stream IDs that identify the streams being retrieved.
     *     In a liveStream resource, the id property specifies the stream's ID.
     * @param {integer=} params.maxResults The maxResults parameter specifies
     *     the maximum number of items that should be returned in the result
     *     set.
     * @param {boolean=} params.mine The mine parameter can be used to instruct
     *     the API to only return streams owned by the authenticated user. Set
     *     the parameter value to true to only retrieve your own streams.
     * @param {string=} params.onBehalfOfContentOwner Note: This parameter is
     *     intended exclusively for YouTube content partners.  The
     *     onBehalfOfContentOwner parameter indicates that the request's
     *     authorization credentials identify a YouTube CMS user who is acting
     ...
     *     other pages that could be retrieved.
     * @param {string} params.part The part parameter specifies a
     *     comma-separated list of one or more liveStream resource properties
     *     that the API response will include. The part names that you can
  ...
  export class Resource$Playlistitems {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.id The id parameter specifies the YouTube playlist
     *     item ID for the playlist item that is being deleted. In a
     *     playlistItem resource, the id property specifies the playlist item's
     *     ID.
     * @param {string=} params.onBehalfOfContentOwner Note: This parameter is
     *     intended exclusively for YouTube content partners.  The
     *     onBehalfOfContentOwner parameter indicates that the request's
     ...
     * @param {object} params Parameters for request
     * @param {string=} params.id The id parameter specifies a comma-separated
     *     list of one or more unique playlist item IDs.
     * @param {integer=} params.maxResults The maxResults parameter specifies
     *     the maximum number of items that should be returned in the result
     *     set.
     * @param {string=} params.onBehalfOfContentOwner Note: This parameter is
     ...
     *     other pages that could be retrieved.
     * @param {string} params.part The part parameter specifies a
     *     comma-separated list of one or more playlistItem resource properties
     *     that the API response will include.  If the parameter identifies a
     *     property that contains child properties, the child properties will be
     *     included in the response. For example, in a playlistItem resource,
     *     the snippet property contains numerous fields, including the title,
     *     description, position, and resourceId properties. As such, if you set
     *     part=snippet, the API response will contain all of those properties.
     * @param {string=} params.playlistId The playlistId parameter specifies the
     *     unique ID of the playlist for which you want to retrieve playlist
     *     items. Note that even though this is an optional parameter, every
     *     request to retrieve playlist items must specify a value for either
     *     the id parameter or the playlistId parameter.
     * @param {string=} params.videoId The videoId parameter specifies that the
     *     request should return only the playlist items that contain the
     *     specified video.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     ...
     *     values, and the request's part parameter value includes the
  ...
  export class Resource$Playlists {
     ...
     * @param {object} params Parameters for request
     * @param {string} params.id The id parameter specifies the YouTube playlist
     *     ID for the playlist that is being deleted. In a playlist resource,
     *     the id property specifies the playlist's ID.
     * @param {string=} params.onBehalfOfContentOwner Note: This parameter is
     *     intended exclusively for YouTube content partners.  The
     *     onBehalfOfContentOwner parameter indicates that the request's
     *     authorization credentials identify a YouTube CMS user who is acting
     ...
     *
     * @param {object} params Parameters for request
     * @param {string=} params.channelId This value indicates that the API
     *     should only return the specified channel's playlists.
     * @param {string=} params.hl The hl parameter should be used for filter out
     *     the properties that are not in the given language. Used for the
     *     snippet part.
     * @param {string=} params.id The id parameter specifies a comma-separated
     *     list of the YouTube playlist ID(s) for the resource(s) that are being
     *     retrieved. In a playlist resource, the id property specifies the
     *     playlist's YouTube playlist ID.
     * @param {integer=} params.maxResults The maxResults parameter specifies
     *     the maximum number of items that should be returned in the result
     *     set.
     * @param {boolean=} params.mine Set this parameter's value to true to
     *     instruct the API to only return playlists owned by the authenticated
     *     user.
     * @param {string=} params.onBehalfOfContentOwner Note: This parameter is
     *     intended exclusively for YouTube content partners.  The
     *     onBehalfOfContentOwner parameter indicates that the request's
     ...
     *     other pages that could be retrieved.
     * @param {string} params.part The part parameter specifies a
     *     comma-separated list of one or more playlist resource properties that
     *     the API response will include.  If the parameter identifies a
     *     property that contains child properties, the child properties will be
     *     included in the response. For example, in a playlist resource, the
     *     snippet property contains properties like author, title, description,
     ...
     *     body specifies. For example, a playlist's description is contained in
     *     the snippet part, which must be included in the request body. If the
     *     request does not specify a value for the snippet.description
  ...
  export class Resource$Search {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string=} params.channelId The channelId parameter indicates that
     *     the API response should only contain resources created by the channel
     * @param {string=} params.channelType The channelType parameter lets you
     *     restrict a search to a particular type of channel.
     * @param {string=} params.eventType The eventType parameter restricts a
     *     search to broadcast events. If you specify a value for this
     *     parameter, you must also set the type parameter's value to video.
     * @param {boolean=} params.forContentOwner Note: This parameter is intended
     *     exclusively for YouTube content partners.  The forContentOwner
     *     parameter restricts the search to only retrieve resources owned by
     *     the content owner specified by the onBehalfOfContentOwner parameter.
     *     The user must be authenticated using a CMS account linked to the
     *     specified content owner and onBehalfOfContentOwner must be provided.
     * @param {boolean=} params.forDeveloper The forDeveloper parameter
     *     restricts the search to only retrieve videos uploaded via the
     *     developer's application or website. The API server uses the request's
     ...
     *     developer's own app or website but not to videos uploaded through
     *     other apps or sites.
     * @param {boolean=} params.forMine The forMine parameter restricts the
     *     search to only retrieve videos owned by the authenticated user. If
     *     you set this parameter to true, then the type parameter's value must
     *     also be set to video.
     * @param {string=} params.location The location parameter, in conjunction
     *     with the locationRadius parameter, defines a circular geographic area
     *     and also restricts a search to videos that specify, in their
     *     metadata, a geographic location that falls within that area. The
     *     parameter value is a string that specifies latitude/longitude
     *     coordinates e.g. (37.42307,-122.08427).   - The location parameter
     *     value identifies the point at the center of the area. - The
     *     locationRadius parameter specifies the maximum distance that the
     *     location associated with a video can be from that point for the video
     *     to still be included in the search results.The API returns an error
     *     if your request specifies a value for the location parameter but does
     *     not also specify a value for the locationRadius parameter.
     * @param {string=} params.locationRadius The locationRadius parameter, in
     ...
     *     parameter values larger than 1000 kilometers.  Note: See the
     *     definition of the location parameter for more information.
     * @param {integer=} params.maxResults The maxResults parameter specifies
     *     the maximum number of items that should be returned in the result
     *     set.
     * @param {string=} params.onBehalfOfContentOwner Note: This parameter is
     ...
     *     individual channel. The CMS account that the user authenticates with
     *     must be linked to the specified YouTube content owner.
     * @param {string=} params.order The order parameter specifies the method
     *     that will be used to order resources in the API response.
     * @param {string=} params.pageToken The pageToken parameter identifies a
     *     specific page in the result set that should be returned. In an API
     *     response, the nextPageToken and prevPageToken properties identify
     *     other pages that could be retrieved.
     * @param {string} params.part The part parameter specifies a
     *     comma-separated list of one or more search resource properties that
     *     the API response will include. Set the parameter value to snippet.
     * @param {string=} params.publishedAfter The publishedAfter parameter
     *     indicates that the API response should only contain resources created
     *     after the specified time. The value is an RFC 3339 formatted
     *     date-time value (1970-01-01T00:00:00Z).
     * @param {string=} params.publishedBefore The publishedBefore parameter
     *     indicates that the API response should only contain resources created
     *     before the specified time. The value is an RFC 3339 formatted
     *     date-time value (1970-01-01T00:00:00Z).
     * @param {string=} params.q The q parameter specifies the query term to
     ...
     * @param {string=} params.regionCode The regionCode parameter instructs the
     *     API to return search results for the specified country. The parameter
     *     value is an ISO 3166-1 alpha-2 country code.
     * @param {string=} params.relatedToVideoId The relatedToVideoId parameter
     *     retrieves a list of videos that are related to the video that the
     *     parameter value identifies. The parameter value must be set to a
     *     YouTube video ID and, if you are using this parameter, the type
     *     parameter must be set to video.
     * @param {string=} params.relevanceLanguage The relevanceLanguage parameter
     ...
     *     two-letter language code. However, you should use the values zh-Hans
     *     for simplified Chinese and zh-Hant for traditional Chinese. Please
     *     note that results in other languages will still be returned if they
     *     are highly relevant to the search query term.
     * @param {string=} params.safeSearch The safeSearch parameter indicates
     *     whether the search results should include restricted content as well
     *     as standard content.
     * @param {string=} params.topicId The topicId parameter indicates that the
     *     API response should only contain resources associated with the
     *     specified topic. The value identifies a Freebase topic ID.
     * @param {string=} params.type The type parameter restricts a search query
     *     to only retrieve a particular type of resource. The value is a
     *     comma-separated list of resource types.
     * @param {string=} params.videoCaption The videoCaption parameter indicates
     *     whether the API should filter video search results based on whether
     *     they have captions. If you specify a value for this parameter, you
     *     must also set the type parameter's value to video.
     * @param {string=} params.videoCategoryId The videoCategoryId parameter
     *     filters video search results based on their category. If you specify
     *     a value for this parameter, you must also set the type parameter's
     *     value to video.
     * @param {string=} params.videoDefinition The videoDefinition parameter
     *     lets you restrict a search to only include either high definition
     *     (HD) or standard definition (SD) videos. HD videos are available for
     *     playback in at least 720p, though higher resolutions, like 1080p,
     *     might also be available. If you specify a value for this parameter,
     *     you must also set the type parameter's value to video.
     * @param {string=} params.videoDimension The videoDimension parameter lets
     *     you restrict a search to only retrieve 2D or 3D videos. If you
     *     specify a value for this parameter, you must also set the type
     *     parameter's value to video.
     * @param {string=} params.videoDuration The videoDuration parameter filters
     *     video search results based on their duration. If you specify a value
     *     for this parameter, you must also set the type parameter's value to
     *     video.
     * @param {string=} params.videoEmbeddable The videoEmbeddable parameter
     *     lets you to restrict a search to only videos that can be embedded
     *     into a webpage. If you specify a value for this parameter, you must
     *     also set the type parameter's value to video.
     * @param {string=} params.videoLicense The videoLicense parameter filters
     *     search results to only include videos with a particular license.
     *     YouTube lets video uploaders choose to attach either the Creative
     *     Commons license or the standard YouTube license to each of their
     *     videos. If you specify a value for this parameter, you must also set
     *     the type parameter's value to video.
     * @param {string=} params.videoSyndicated The videoSyndicated parameter
     *     lets you to restrict a search to only videos that can be played
     *     outside youtube.com. If you specify a value for this parameter, you
     *     must also set the type parameter's value to video.
     * @param {string=} params.videoType The videoType parameter lets you
     *     restrict a search to a particular type of videos. If you specify a
  ...
  export class Resource$Sponsors {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string=} params.filter The filter parameter specifies which
     *     channel sponsors to return.
     * @param {integer=} params.maxResults The maxResults parameter specifies
     *     the maximum number of items that should be returned in the result
     *     set.
     * @param {string=} params.pageToken The pageToken parameter identifies a
     ...
     *     response, the nextPageToken and prevPageToken properties identify
     *     other pages that could be retrieved.
     * @param {string} params.part The part parameter specifies the sponsor
  ...
  export class Resource$Subscriptions {
     ...
     * @param {object} params Parameters for request
     * @param {string} params.id The id parameter specifies the YouTube
     *     subscription ID for the resource that is being deleted. In a
     ...
     *     YouTube channel ID. The API will only return that channel's
     *     subscriptions.
     * @param {string=} params.forChannelId The forChannelId parameter specifies
     *     a comma-separated list of channel IDs. The API response will then
     *     only contain subscriptions matching those channels.
     * @param {string=} params.id The id parameter specifies a comma-separated
     *     list of the YouTube subscription ID(s) for the resource(s) that are
     *     being retrieved. In a subscription resource, the id property
     ...
     * @param {boolean=} params.myRecentSubscribers Set this parameter's value
     *     to true to retrieve a feed of the subscribers of the authenticated
     *     user in reverse chronological order (newest first).
     * @param {boolean=} params.mySubscribers Set this parameter's value to true
     *     to retrieve a feed of the subscribers of the authenticated user in no
     *     particular order.
     * @param {string=} params.onBehalfOfContentOwner Note: This parameter is
     *     intended exclusively for YouTube content partners.  The
     *     onBehalfOfContentOwner parameter indicates that the request's
     ...
     *     for each separate channel.
     * @param {string=} params.order The order parameter specifies the method
     *     that will be used to sort resources in the API response.
     * @param {string=} params.pageToken The pageToken parameter identifies a
     *     specific page in the result set that should be returned. In an API
     *     response, the nextPageToken and prevPageToken properties identify
     *     other pages that could be retrieved.
     * @param {string} params.part The part parameter specifies a
     *     comma-separated list of one or more subscription resource properties
     *     that the API response will include.  If the parameter identifies a
     *     property that contains child properties, the child properties will be
     *     included in the response. For example, in a subscription resource,
  ...
  export class Resource$Superchatevents {
     ...
     *     other pages that could be retrieved.
     * @param {string} params.part The part parameter specifies the
     *     superChatEvent resource parts that the API response will include.
     *     Supported values are id and snippet.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
  ...
  export class Resource$Thumbnails {
     ...
     *     authenticates with must be linked to the specified YouTube content
     *     owner.
     * @param {string} params.videoId The videoId parameter specifies a YouTube
     *     video ID for which the custom video thumbnail is being provided.
     * @param {object} params.media Media object
     * @param {string} params.media.mimeType Media mime-type
     * @param {string|object} params.media.body Media body contents
     * @param {object} [options] Optionally override request options, such as
  ...
  export class Resource$Videoabusereportreasons {
     ...
     *     should be used for text values in the API response.
     * @param {string} params.part The part parameter specifies the
     *     videoCategory resource parts that the API response will include.
     *     Supported values are id and snippet.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
  ...
  export class Resource$Videocategories {
     ...
     *     should be used for text values in the API response.
     * @param {string=} params.id The id parameter specifies a comma-separated
     *     list of video category IDs for the resources that you are retrieving.
     * @param {string} params.part The part parameter specifies the
     *     videoCategory resource properties that the API response will include.
     *     Set the parameter value to snippet.
     * @param {string=} params.regionCode The regionCode parameter instructs the
     *     API to return the list of video categories available in the specified
     *     country. The parameter value is an ISO 3166-1 alpha-2 country code.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
  ...
  export class Resource$Videos {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.id The id parameter specifies the YouTube video ID
     ...
     * @param {object} params Parameters for request
     * @param {string} params.id The id parameter specifies a comma-separated
     *     list of the YouTube video ID(s) for the resource(s) for which you are
     *     retrieving rating data. In a video resource, the id property
     ...
     *
     * @param {object} params Parameters for request
     * @param {boolean=} params.autoLevels The autoLevels parameter indicates
     *     whether YouTube should automatically enhance the video's lighting and
     *     color.
     * @param {boolean=} params.notifySubscribers The notifySubscribers
     *     parameter indicates whether YouTube should send a notification about
     *     the new video to users who subscribe to the video's channel. A
     *     parameter value of True indicates that subscribers will be notified
     *     of newly uploaded videos. However, a channel owner who is uploading
     ...
     * @param {boolean=} params.stabilize The stabilize parameter indicates
     *     whether YouTube should adjust the video to remove shaky camera
     *     motions.
     * @param  {object} params.resource Media resource metadata
     * @param {object} params.media Media object
     * @param {string} params.media.mimeType Media mime-type
     ...
     *
     * @param {object} params Parameters for request
     * @param {string=} params.chart The chart parameter identifies the chart
     ...
     *     resource's default language.
     * @param {string=} params.id The id parameter specifies a comma-separated
     *     list of the YouTube video ID(s) for the resource(s) that are being
     *     retrieved. In a video resource, the id property specifies the video's
     *     ID.
     * @param {string=} params.locale DEPRECATED
     * @param {integer=} params.maxHeight The maxHeight parameter specifies a
     *     maximum height of the embedded player. If maxWidth is provided,
     *     maxHeight may not be reached in order to not violate the width
     *     request.
     * @param {integer=} params.maxResults The maxResults parameter specifies
     *     the maximum number of items that should be returned in the result
     *     set.  Note: This parameter is supported for use in conjunction with
     *     the myRating and chart parameters, but it is not supported for use in
     *     conjunction with the id parameter.
     * @param {integer=} params.maxWidth The maxWidth parameter specifies a
     *     maximum width of the embedded player. If maxHeight is provided,
     *     maxWidth may not be reached in order to not violate the height
     *     request.
     * @param {string=} params.myRating Set this parameter's value to like or
     *     dislike to instruct the API to only return videos liked or disliked
     ...
     *     specific page in the result set that should be returned. In an API
     *     response, the nextPageToken and prevPageToken properties identify
     *     other pages that could be retrieved.  Note: This parameter is
     *     supported for use in conjunction with the myRating and chart
     *     parameters, but it is not supported for use in conjunction with the
     *     id parameter.
     * @param {string} params.part The part parameter specifies a
     *     comma-separated list of one or more video resource properties that
     *     the API response will include.  If the parameter identifies a
     *     property that contains child properties, the child properties will be
     *     included in the response. For example, in a video resource, the
     *     snippet property contains the channelId, title, description, tags,
     *     and categoryId properties. As such, if you set part=snippet, the API
     *     response will contain all of those properties.
     * @param {string=} params.regionCode The regionCode parameter instructs the
     *     API to select a video chart available in the specified region. This
     *     parameter can only be used in conjunction with the chart parameter.
     *     The parameter value is an ISO 3166-1 alpha-2 country code.
     * @param {string=} params.videoCategoryId The videoCategoryId parameter
     *     identifies the video category for which the chart should be
     *     retrieved. This parameter can only be used in conjunction with the
     *     chart parameter. By default, charts are not restricted to a
     *     particular category.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     ...
     * @param {object} params Parameters for request
     * @param {string} params.id The id parameter specifies the YouTube video ID
     *     of the video that is being rated or having its rating removed.
     ...
     *     include.  Note that this method will override the existing values for
     *     all of the mutable properties that are contained in any parts that
     *     the parameter value specifies. For example, a video's privacy setting
     *     is contained in the status part. As such, if your request is updating
     *     a private video, and the request's part parameter value includes the
     *     status part, the video's privacy setting will be updated to whatever
     *     value the request body specifies. If the request body does not
     *     specify a value, the existing privacy setting will be removed and the
     *     video will revert to the default privacy setting.  In addition, not
     *     all parts contain properties that can be set when inserting or
  ...
  export class Resource$Watermarks {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.channelId The channelId parameter specifies the
