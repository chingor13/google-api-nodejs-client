...
export namespace adsensehost_v4_1 {
  ...
  export class Resource$Accounts$Adunits {
     ...
     * @param {string=} params.hostCustomChannelId Host custom channel to attach
     *     to the ad code.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     ...
     * @param {string} params.adClientId Ad client into which to insert the ad
     *     unit.
  ...
  export class Resource$Associationsessions {
     ...
     * @param {string=} params.websiteLocale The locale of the user's hosted
     *     website.
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.token The token returned to the association
     *     callback URL.
     * @param {object} [options] Optionally override request options, such as
     *     `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
  ...
  export class Resource$Customchannels {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.adClientId Ad client from which to delete the
     *     custom channel.
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.adClientId Ad client from which to get the custom
     *     channel.
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.adClientId Ad client to which the new custom
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.adClientId Ad client in which the custom channel
     *     will be updated.
     * @param {string} params.customChannelId Custom channel to get.
     * @param {().CustomChannel} params.resource Request body data
     * @param {object} [options] Optionally override request options, such as
  ...
  export class Resource$Urlchannels {
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.adClientId Ad client from which to delete the URL
     *     channel.
     ...
     *
     * @param {object} params Parameters for request
     * @param {string} params.adClientId Ad client to which the new URL channel
     *     will be added.
